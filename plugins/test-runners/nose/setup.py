...
setup(
    name='cosmic_ray_nose_runner',
    version=find_version('cosmic_ray_nose_runner/version.py'),
    packages=find_packages(exclude=['contrib', 'docs', 'test*']),

    author='Sixty North AS',
    author_email='austin@sixty-north.com',
    description='Nose test runner for Cosmic Ray',
    license='MIT',
    keywords='',
    ...
    entry_points={
        'cosmic_ray.test_runners': [
            'nose = cosmic_ray_nose_runner.runner:NoseRunner',
        ],
    },
